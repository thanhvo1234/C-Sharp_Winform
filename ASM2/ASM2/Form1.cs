...
namespace ASM2
{
    public partial class Form1 : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e) //Text entered in sender
        {
        ...
        private void btFix_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewSV[2, index].Value = dateTimePicker1.Text; //Update value
        ...
        private void dataGridViewSV_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dateTimePicker1.Text = row.Cells[2].Value.ToString();// Put the data in the cellclick into the input text.
        ...
        private void btStatistics_Click(object sender, EventArgs e)
        {
            if (rbMin.Checked)
            {
                ...
                {
                    double medigrade = Convert.ToDouble(dataGridViewSV[8, i].Value);
                    if (medigrade >= 0 && medigrade < 5)
                    {
